...
public class CalculatorUsingVBoxHBox extends Application {
	...
	public void start(Stage arg0) throws Exception {
		...
		CalculationHandler calcHandler = 
				new CalculationHandler(calculationLabel);
		
		setButtonHandler(calcHandler,
				number7, number4, number1, number0,
				number8, number5, number2, numberdot,
				number9, number6, number3, numberequal,
				numberDivide, numberMultiply, 
				numberSubtract, numberAdd, clear);
	...
	public void setButtonHandler(
			CalculationHandler calc, Button... buttons) {
		for(Button button : buttons) {
